...
The objective of this project is to develop and maintain a package that provides [Ubiquiti's](http://www.ubnt.com/) UniFi Controller software for the FreeBSD-based jail. Current testing 5.8.12 Version - Not for Production
...
Upgrade
-------
Working on the upgrade process - Upgrade to current is working to current unstable 5.8.12 Version - Not for Production
